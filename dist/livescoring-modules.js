...
var m = typeof localStorage < "u" && localStorage.getItem("pestovo_lang") || "ru", f = {
  ru: {
    ...
    bn_guide: "Поле",
    bn_menu: "Меню",
    nav_guide: "Книга поля",
    nav_feed: "Лента событий",
    nav_predictor: "Симулятор WHS",
    nav_oom: "Зачёт сезона",
    nav_players: "Игроки",
  ...
  en: {
    ...
    bn_guide: "Course",
    bn_menu: "Menu",
    nav_guide: "Course Guide",
    nav_feed: "Live Feed",
    nav_predictor: "WHS Predictor",
    nav_oom: "Order of Merit",
    nav_players: "Players",
