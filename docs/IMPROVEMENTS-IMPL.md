...
## 8. Итерации 5–9: дробление `admin.js` — десять фичи-модулей
...
**8380 → 2807 строк (-67%)** — в файле остались: авторизация, группы/контроль
темпа, турниры (+waitlist/дивизионы/умные группы), игроки/роли, misc., извлечены полностью автономные блоки
