...
## 8. Итерация 5: дробление `admin.js` — три фичи-модуля
...
**8380 → 7306 строк (-1074)**, извлечены полностью автономные блоки
...
- Внешние вызовы (`openAdminPanel`, `switchTab`, onclick-строки) —
  ...
  в admin.html модули подключены рядом с `admin.js`.
