...
## 8. Итерации 5–10: дробление `admin.js` — тринадцать фичи-модулей
...
**8380 → 1052 строки (-87%)** — в admin.js остались только связное ядро:
авторизация (мастер-пароль, openAdminPanel, switchTab) и «Группы, которые
сейчас играют / контроль темпа» (следующий кандидат на вынос)., извлечены полностью автономные блоки
