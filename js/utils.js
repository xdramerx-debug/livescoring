// NOTE: course config + score formatting were extracted to js/course-config.js and js/format.js
// (both loaded BEFORE this file on every page). Do not re-add them here.
