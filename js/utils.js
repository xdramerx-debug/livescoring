// ==========================================
// ГОЛЬФ-КЛУБ ПЕСТОВО — ПОЛНЫЕ ДАННЫЕ
// ==========================================
...
const HCP_TABLE = {
    men: {
        bk: [
            ['+3.5','+2.8',0],['+2.7','+2.0',1],['+1.9','+1.2',2],['+1.1','+0.4',3],
            ['+0.3','0.3',4],['0.4','1.1',5],['1.2','1.9',6],['2.0','2.7',7],
            ['2.8','3.5',8],['3.6','4.3',9],['4.4','5.1',10],['5.2','5.8',11],
            ['5.9','6.6',12],['6.7','7.4',13],['7.5','8.2',14],['8.3','9.0',15],
            ['9.1','9.8',16],['9.9','10.5',17],['10.6','11.3',18],['11.4','12.1',19],
            ['12.2','12.9',20],['13.0','13.7',21],['13.8','14.5',22],['14.6','15.3',23],
            ['15.4','16.0',24],['16.1','16.8',25],['16.9','17.6',26],['17.7','18.4',27],
            ['18.5','19.2',28],['19.3','20.0',29],['20.1','20.7',30],['20.8','21.5',31],
            ['21.6','22.3',32],['22.4','23.1',33],['23.2','23.9',34],['24.0','24.7',35],
            ['24.8','25.5',36],['25.6','26.2',37],['26.3','27.0',38],['27.1','27.8',39],
            ['27.9','28.6',40],['28.7','29.4',41],['29.5','30.2',42],['30.3','30.9',43],
            ['31.0','31.7',44],['31.8','32.5',45],['32.6','33.3',46],['33.4','34.1',47],
            ['34.2','34.9',48],['35.0','35.7',49],['35.8','36.4',50],['36.5','37.2',51],
            ['37.3','38.0',52],['38.1','38.8',53],['38.9','39.6',54],['39.7','40.4',55],
            ['40.5','41.1',56],['41.2','41.9',57],['42.0','42.7',58],['42.8','43.5',59],
            ['43.6','44.3',60],['44.4','45.1',61],['45.2','45.9',62],['46.0','46.6',63],
            ['46.7','47.4',64],['47.5','48.2',65],['48.3','49.0',66],['49.1','49.8',67],
            ['49.9','50.6',68],['50.7','51.3',69],['51.4','52.1',70],['52.2','52.9',71],
            ['53.0','53.7',72],['53.8','54.0',73]
        ],
        bl: [
            ['+3.5','+2.8',0],['+2.7','+1.9',1],['+1.8','+1.1',2],['+1.0','+0.3',3],
            ['+0.2','0.5',4],['0.6','1.4',5],['1.5','2.2',6],['2.3','3.0',7],
            ['3.1','3.8',8],['3.9','4.7',9],['4.8','5.6',10],['5.6','6.3',11],
            ['6.4','7.1',12],['7.2','8.0',13],['8.1','8.8',14],['8.9','9.6',15],
            ['9.7','10.4',16],['10.5','11.3',17],['11.4','12.2',18],['12.2','12.9',19],
            ['13.0','13.7',20],['13.8','14.5',21],['14.6','15.4',22],['15.5','16.2',23],
            ['16.3','17.0',24],['17.1','17.8',25],['17.9','18.7',26],['18.8','19.5',27],
            ['19.6','20.3',28],['20.4','21.1',29],['21.2','22.0',30],['22.1','22.8',31],
            ['22.9','23.6',32],['23.7','24.4',33],['24.5','25.3',34],['25.4','26.1',35],
            ['26.2','26.9',36],['27.0','27.7',37],['27.8','28.6',38],['28.7','29.4',39],
            ['29.5','30.2',40],['30.3','31.0',41],['31.1','31.9',42],['32.0','32.7',43],
            ['32.8','33.5',44],['33.6','34.3',45],['34.4','35.2',46],['35.3','36.0',47],
            ['36.1','36.8',48],['36.9','37.6',49],['37.7','38.5',50],['38.6','39.3',51],
            ['39.4','40.1',52],['40.2','40.9',53],['41.0','41.8',54],['41.9','42.6',55],
            ['42.7','43.4',56],['43.5','44.2',57],['44.3','45.1',58],['45.2','45.9',59],
            ['46.0','46.7',60],['46.8','47.5',61],['47.6','48.4',62],['48.5','49.2',63],
            ['49.3','50.0',64],['50.1','50.8',65],['50.9','51.7',66],['51.8','52.5',67],
            ['52.6','53.3',68],['53.4','54.0',69]
        ],
        wh: [
            ['+3.7','+3.0',0],['+2.9','+2.1',1],['+2.0','+1.3',2],['+1.2','+0.5',3],
            ['+0.4','0.4',4],['0.5','1.2',5],['1.3','2.0',6],['2.1','2.9',7],
            ['2.8','3.5',8],['3.7','4.4',9],['4.5','5.3',10],['5.4','6.1',11],
            ['6.2','6.9',12],['7.0','7.8',13],['7.9','8.6',14],['8.7','9.5',15],
            ['9.6','10.3',16],['10.4','11.2',17],['11.3','12.0',18],['12.1','12.9',19],
            ['13.0','13.7',20],['13.8','14.5',21],['14.6','15.4',22],['15.5','16.2',23],
            ['16.3','17.1',24],['17.2','17.9',25],['18.0','18.8',26],['18.9','19.6',27],
            ['19.7','20.5',28],['20.6','21.3',29],['21.4','22.1',30],['22.2','23.0',31],
            ['23.1','23.8',32],['23.9','24.6',33],['24.7','25.5',34],['25.6','26.3',35],
            ['26.4','27.2',36],['27.3','28.0',37],['28.1','28.8',38],['28.9','29.7',39],
            ['29.8','30.5',40],['30.6','31.3',41],['31.4','32.2',42],['32.3','33.0',43],
            ['33.1','33.9',44],['34.0','34.7',45],['34.8','35.5',46],['35.6','36.4',47],
            ['36.5','37.2',48],['37.3','38.0',49],['38.1','38.9',50],['39.0','39.7',51],
            ['39.8','40.5',52],['40.6','41.4',53],['41.5','42.2',54],['42.3','43.0',55],
            ['43.1','43.8',56],['43.9','44.7',57],['44.8','45.5',58],['45.6','46.3',59],
            ['46.4','47.2',60],['47.3','48.0',61],['48.1','48.8',62],['48.9','49.7',63],
            ['49.8','50.5',64],['50.6','51.4',65]
        ],
        rd: [
            ['+3.1','+2.3',0],['+2.2','+1.5',1],['+1.4','+0.6',2],['+0.5','0.2',3],
            ['0.3','1.0',4],['1.1','1.9',5],['2.0','2.7',6],['2.8','3.5',7],
            ['3.7','4.4',8],['4.5','5.3',9],['5.4','6.1',10],['6.2','6.9',11],
            ['7.0','7.8',12],['7.9','8.6',13],['8.7','9.5',14],['9.6','10.3',15],
            ['10.4','11.2',16],['11.3','12.0',17],['12.1','12.9',18],['13.0','13.7',19],
            ['13.8','14.5',20],['14.6','15.4',21],['15.5','16.2',22],['16.3','17.1',23],
            ['17.2','17.9',24],['18.0','18.8',25],['18.9','19.6',26],['19.7','20.5',27],
            ['20.6','21.3',28],['21.4','22.1',29],['22.2','23.0',30],['23.1','23.8',31],
            ['23.9','24.6',32],['24.7','25.5',33],['25.6','26.3',34],['26.4','27.2',35],
            ['27.3','28.0',36],['28.1','28.8',37],['28.9','29.7',38],['29.8','30.5',39],
            ['30.6','31.3',40]
        ]
    },
    women: {
        bl: [
            ['+6.8','+6.2',0],['+6.1','+5.4',1],['+5.3','+4.7',2],['+4.6','+4.0',3],
            ['+3.9','+3.2',4],['+3.1','+2.5',5],['+2.4','+1.7',6],['+1.6','+0.9',7],
            ['+0.9','0.3',8],['0.3','1.0',9],['1.0','1.7',10],['1.7','2.4',11],
            ['2.4','3.1',12],['3.1','3.8',13],['3.9','4.5',14],['4.6','5.3',15],
            ['5.3','6.0',16],['6.0','6.7',17],['6.8','7.4',18],['7.5','8.2',19],['8.2','8.9',20]
        ],
        wh: [
            ['+5.6','+4.9',0],['+4.8','+4.1',1],['+4.0','+3.3',2],['+3.2','+2.5',3],
            ['+2.4','+1.7',4],['+1.6','+0.9',5],['+0.8','+0.1',6],['0.0','0.7',7],
            ['0.8','1.5',8],['1.6','2.3',9],['2.4','3.1',10],['3.2','3.9',11],
            ['4.0','4.7',12],['4.8','5.5',13],['5.6','6.3',14],['6.4','7.1',15],
            ['7.2','7.9',16],['8.0','8.7',17],['8.8','9.5',18],['9.6','10.3',19],['10.4','11.1',20]
        ],
        rd: [
            ['+3.0','+2.3',0],['+2.2','+1.5',1],['+1.4','+0.6',2],['+0.5','0.2',3],
            ['0.3','1.0',4],['1.1','1.9',5],['2.0','2.7',6],['2.8','3.5',7],
            ['3.7','4.4',8],['4.5','5.3',9],['5.4','6.1',10],['6.2','6.9',11],
            ['7.0','7.8',12],['7.9','8.6',13],['8.7','9.5',14],['9.6','10.3',15]
        ]
...
function fmtDateTime(ts){if(!ts)return'—';var d=new Date(ts);return d.toLocaleDateString('ru-RU')+' '+d.toLocaleTimeString('ru-RU',{hour:'2-digit',minute:'2-digit'});}
...
// ФИКСИРОВАННЫЙ holeOrder — стартовая лунка преобразуется строго в ЧИСЛО!
function holeOrder(sh) {
    var o = [];
    var h = parseInt(sh) || 1;
    for (var i = 0; i < 18; i++) {
        o.push(h);
...
function downloadScorecard(roundId){
    db.ref('rounds/'+roundId).once('value').then(function(sn){
        ...
        Object.entries(pl).forEach(function(pe){
            ...
            h+='<table><tr><th>Лунка</th>';for(var i=1;i<=9;i++)h+='<th>'+i+'</th>';h+='<th>Аут</th></tr>';
            h+='<tr><td><b>'+TEES[tee]+'</b></td>';var dO=0;for(var i=1;i<=9;i++){var d=holeDist(i,tee);dO+=d;h+='<td>'+d+'</td>';}h+='<td class="tot">'+dO+'</td></tr>';
            h+='<tr class="pr"><td>Пар</td>';var pO=0;for(var i=1;i<=9;i++){var pv=holePar(i);pO+=pv;h+='<td>'+pv+'</td>';}h+='<td class="tot">'+pO+'</td></tr>';
            h+='<tr class="hc"><td>Индекс</td>';for(var i=1;i<=9;i++)h+='<td>'+holeHcp(i)+'</td>';h+='<td></td></tr>';
            h+='<tr><td><b>Счёт</b></td>';var gO=0;for(var i=1;i<=9;i++){var sv=parseInt(sc[i])||0,pv=holePar(i),cl='';if(sv>=1){gO+=sv;var df=sv-pv;if(df<=-2)cl='eag';else if(df===-1)cl='bir';else if(df===1)cl='bog';else if(df>=2)cl='dbb';}h+='<td class="'+cl+'">'+(sv>=1?sv:'')+'</td>';}h+='<td class="tot">'+(gO>0?gO:'')+'</td></tr>';
            h+='</table>';
        });
    ...
    Object.entries(players).forEach(function(pe) {
        ...
        if (isGuestPlayer) {
            db.ref('users').orderByChild('name').equalTo(p.name || 'Гость').once('value').then(function(usn) {
                var existingId = null;
                var existing = usn.val() || {};
                Object.entries(existing).forEach(function(ue) {
                    if (ue[1].isGuest === true) existingId = ue[0];
                });
                if (existingId) {
                    saveHistoryEntry(existingId, roundId, rd, p, stats);
                } else {
                    var newRef = db.ref('users').push();
                    newRef.set({
                        name: p.name || 'Гость', firstName: p.firstName || '', lastName: p.lastName || '',
                        email: '', role: 'guest', gender: p.gender || 'men',
                        handicap: eH || null, createdAt: Date.now(),
                        roundsPlayed: 0, bestGross: null, bestStableford: null, isGuest: true
                    }).then(function() { saveHistoryEntry(newRef.key, roundId, rd, p, stats); });
                }
            });
        } else {
            saveHistoryEntry(pid, roundId, rd, p, stats);
        }
    });
}
...
function saveHistoryEntry(userId, roundId, rd, p, stats) {
    ...
    db.ref('users/' + userId + '/history').push({
        roundId: roundId, date: rd.completedAt || Date.now(),
        tee: rd.tee || 'wh', format: rd.format || 'Stroke Play',
        mode: rd.mode || 'group', startHole: rd.startHole || 1,
        gross: stats.gross, toPar: stats.toPar,
        net: stats.net, netToPar: stats.netToPar,
        stablefordField: stats.stablefordField, stablefordExact: stats.stablefordExact,
        holes: stats.holesPlayed, scores: sc,
        birdies: stats.birdies, eagles: stats.eagles,
        pars: stats.pars, holeInOne: stats.holeInOne,
        exactHcp: p.exactHcp || 0, fieldHcp: p.fieldHcp || 0, gender: p.gender || 'men'
    });
    
    db.ref('users/' + userId + '/roundsPlayed').transaction(function(v) { return (v || 0) + 1; });

    // РЕКОРДЫ ОБНОВЛЯЮТСЯ СТРОГО ТОЛЬКО ПРИ 18 ЛУНКАХ!
