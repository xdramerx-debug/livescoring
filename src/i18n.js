// ESM canonical i18n (RU/EN dictionary, t(), toggleLang(), applyTranslations).
// Mirrors js/i18n.js — the classic-script copy that the legacy pages load.
// No Firebase dependencies; js/format.js calls t() at call time only, so this
// module is safe to load before utils. Exposes globals on window during the
// migration (see src/course-config.js).
// ==========================================
// МЕЖДУНАРОДНЫЙ ЯЗЫКОВОЙ ПЕРЕКЛЮЧАТЕЛЬ (RU / EN)
// ==========================================
export var currentLang = (typeof localStorage !== 'undefined' && localStorage.getItem('pestovo_lang')) || 'ru';
...
if (typeof window !== 'undefined') {
    Object.assign(window, { currentLang, I18N, t, toggleLang, updateLangButtons, applyTranslations, updateFooterYear });
}
