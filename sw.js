const CACHE_NAME = 'pestovo-v1.47.0';
...
const STATIC_ASSETS = [
    ...
    'manifest.json', 'css/style.css?v=26', 'css/assistant.css?v=2',
    'css/design-presets.css?v=1',
    'js/firebase-config.js?v=2', 'js/utils.js?v=46', 'js/name-variants.js?v=1',
    ...
    'js/order-of-merit.js?v=3', 'js/pwa.js?v=2', 'js/start-admin.js?v=10', 'js/qr-start.js?v=4', 'qr-start.html',
