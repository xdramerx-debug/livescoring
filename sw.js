const CACHE_NAME = 'pestovo-v1.32.0';
...
const STATIC_ASSETS = [
    ...
    'assistant.html',
    'manifest.json', 'css/style.css?v=21', 'css/assistant.css?v=2',
    'js/firebase-config.js', 'js/utils.js?v=38', 'js/name-variants.js?v=1',
    'js/auth.js', 'js/app.js?v=13', 'js/live.js?v=21', 'js/solo.js?v=22',
    'js/leaderboard.js?v=5', 'js/players.js?v=2', 'js/tournaments.js?v=3',
    'js/stats.js?v=3', 'js/handicap.js', 'js/admin.js?v=24', 'js/scorer.js?v=4',
