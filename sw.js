const CACHE_NAME = 'pestovo-v1.11.0';
...
const STATIC_ASSETS = [
    ...
    'manifest.json', 'css/style.css', 'js/firebase-config.js', 'js/utils.js?v=19',
    'js/auth.js', 'js/app.js', 'js/live.js?v=17', 'js/solo.js?v=17',
