const CACHE_NAME = 'pestovo-v1.42.0';
...
const STATIC_ASSETS = [
    ...
    'js/firebase-config.js?v=2', 'js/utils.js?v=44', 'js/name-variants.js?v=1',
    'js/design-system.js?v=1', 'js/design-admin.js?v=2', 'js/design-preview.js?v=1',
    'js/auth.js', 'js/app.js?v=15', 'js/live.js?v=25', 'js/solo.js?v=25',
    'js/leaderboard.js?v=6', 'js/players.js?v=3', 'js/tournaments.js?v=4',
    'js/stats.js?v=3', 'js/handicap.js', 'js/admin.js?v=32', 'js/scorer.js?v=4',
    'js/marker.js?v=2', 'js/guide.js', 'js/feed.js?v=2', 'js/predictor.js',
    'js/order-of-merit.js?v=3', 'js/pwa.js?v=2', 'js/start-admin.js?v=6', 'js/qr-start.js?v=2', 'qr-start.html',
