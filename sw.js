const CACHE_NAME = 'pestovo-v1.80.0';
...
const STATIC_ASSETS = [
    ...
    'js/firebase-config.js?v=2', 'js/course-config.js?v=1', 'js/format.js?v=1', 'js/safe-html.js?v=1', 'js/dom.js?v=1', 'js/utils.js?v=66', 'js/name-variants.js?v=1',
