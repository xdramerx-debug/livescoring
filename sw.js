const CACHE_NAME = 'pestovo-v1.17.1';
...
const STATIC_ASSETS = [
    ...
    'manifest.json', 'css/style.css?v=5', 'js/firebase-config.js', 'js/utils.js?v=22',
    'js/auth.js', 'js/app.js?v=5', 'js/live.js?v=17', 'js/solo.js?v=18',
