const CACHE_NAME = 'pestovo-v1.63.0';
...
const STATIC_ASSETS = [
    ...
    'js/firebase-config.js?v=2', 'js/utils.js?v=57', 'js/name-variants.js?v=1',
    'js/design-system.js?v=1', 'js/design-admin.js?v=2', 'js/design-preview.js?v=1',
    'js/auth.js', 'js/app.js?v=19', 'js/live.js?v=33', 'js/solo.js?v=27',
    ...
    'js/order-of-merit.js?v=3', 'js/pwa.js?v=5', 'js/start-admin.js?v=19', 'js/pe-edit.js?v=1', 'js/qr-start.js?v=10', 'qr-start.html',
