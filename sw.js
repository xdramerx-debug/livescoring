const CACHE_NAME = 'pestovo-v1.10.0';
...
const STATIC_ASSETS = [
    ...
    'manifest.json', 'css/style.css', 'js/firebase-config.js', 'js/utils.js?v=18',
    'js/auth.js', 'js/app.js', 'js/live.js?v=15', 'js/solo.js?v=15',
    'js/leaderboard.js', 'js/players.js', 'js/tournaments.js',
    'js/stats.js', 'js/handicap.js', 'js/admin.js?v=13', 'js/scorer.js',
