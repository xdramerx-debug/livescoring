const CACHE_NAME = 'pestovo-v1.64.0';
...
const STATIC_ASSETS = [
    ...
    'js/firebase-config.js?v=2', 'js/utils.js?v=58', 'js/name-variants.js?v=1',
    'js/design-system.js?v=1', 'js/design-admin.js?v=2', 'js/design-preview.js?v=1',
    'js/auth.js', 'js/app.js?v=20', 'js/live.js?v=34', 'js/solo.js?v=27',
    'js/leaderboard.js?v=8', 'js/players.js?v=3', 'js/tournaments.js?v=12', 'js/protocol.js?v=2',
    'js/stats.js?v=4', 'js/handicap.js', 'js/admin.js?v=44', 'js/scorer.js?v=8',
    'js/marker.js?v=4', 'js/guide.js', 'js/feed.js?v=3', 'js/predictor.js',
    'js/order-of-merit.js?v=3', 'js/pwa.js?v=6', 'js/start-admin.js?v=20', 'js/pe-edit.js?v=1', 'js/qr-start.js?v=10', 'qr-start.html',
