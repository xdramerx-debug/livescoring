const CACHE_NAME = 'pestovo-v1.75.0';
...
const STATIC_ASSETS = [
    ...
    'js/firebase-config.js?v=2', 'js/utils.js?v=64', 'js/name-variants.js?v=1',
    'js/tn-engine.js?v=1', 'js/tn-wizard.js?v=1',
    'js/design-system.js?v=1', 'js/design-admin.js?v=2', 'js/design-preview.js?v=1',
    'js/auth.js', 'js/app.js?v=21', 'js/live.js?v=39', 'js/solo.js?v=31', 'js/round-setup.js?v=1',
