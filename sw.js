const CACHE_NAME = 'pestovo-v1.46.0';
...
const STATIC_ASSETS = [
    ...
    'manifest.json', 'css/style.css?v=25', 'css/assistant.css?v=2',
    ...
    'js/order-of-merit.js?v=3', 'js/pwa.js?v=2', 'js/start-admin.js?v=9', 'js/qr-start.js?v=3', 'qr-start.html',
