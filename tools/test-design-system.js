...
(function testWiring() {
    ...
    pages.forEach(function(file) {
        ...
        if (html.indexOf('version-number') !== -1) {
            ok(html.indexOf('1.56.0') !== -1, file + ': версия сайта не обновлена до 1.56.0');
            ok(html.indexOf('1.55.0') === -1, file + ': осталась старая версия 1.55.0');
        }
    });
    ...
    ok(sw.indexOf("pestovo-v1.56.0") !== -1, 'sw.js: кэш не обновлён до 1.56.0');
