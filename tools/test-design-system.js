...
(function testWiring() {
    ...
    pages.forEach(function(file) {
        ...
        if (html.indexOf('version-number') !== -1) {
            ok(html.indexOf('1.34.0') !== -1, file + ': версия сайта не обновлена до 1.34.0');
            ok(html.indexOf('1.33.0') === -1, file + ': осталась старая версия 1.33.0');
        }
    });
    ...
    ok(sw.indexOf("pestovo-v1.34.0") !== -1, 'sw.js: кэш не обновлён до 1.34.0');
