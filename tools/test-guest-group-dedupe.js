...
vm.runInContext(fs.readFileSync(path.join(ROOT, 'js/i18n.js'), 'utf8'), sandbox, { filename: 'utils.js' });
vm.runInContext(fs.readFileSync(path.join(ROOT, 'js/official-alerts.js'), 'utf8'), sandbox, { filename: 'utils.js' });
